...
%            Number of atoms       :   58 (   2 equality;  34 variable)
%            Maximal formula depth :   21 (  21 average)
%            Number of connectives :   56 (   0   ~;   1   |;   9   &;  45   @)
%                                         (   0 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
    ...
    ! [V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point',V_Epsilon: 'SetOf' @ '2d.Point',V_S1: 'SetOf' @ '2d.Point',V_S2: 'SetOf' @ '2d.Point'] :
      ( ( ( '2d.is-equilateral-triangle/3' @ V_A @ V_B @ V_C )
        & ( V_Epsilon
          = ( 'set-by-def/1'
            @ ^ [V_p: '2d.Point'] :
                ( '2d.on/2' @ V_p @ ( '2d.union/1' @ ( 'cons/2' @ ( '2d.seg/2' @ V_A @ V_B ) @ ( 'cons/2' @ ( '2d.seg/2' @ V_B @ V_C ) @ ( 'cons/2' @ ( '2d.seg/2' @ V_C @ V_A ) @ 'nil/0' ) ) ) ) ) ) )
        & ( 'is-empty/1' @ ( 'set-intersection/2' @ V_S1 @ V_S2 ) )
        & ( V_Epsilon
          = ( 'set-union/2' @ V_S1 @ V_S2 ) ) )
     => ( ? [V_a_dot_0: '2d.Point',V_b_dot_0: '2d.Point',V_c_dot_0: '2d.Point'] :
            ( ( 'elem/2' @ V_a_dot_0 @ V_S1 )
            & ( 'elem/2' @ V_b_dot_0 @ V_S1 )
            & ( 'elem/2' @ V_c_dot_0 @ V_S1 )
