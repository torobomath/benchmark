...
thf(p,conjecture,(
    ! [V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point',V_D: '2d.Point',V_H: '2d.Point',V_S: '2d.Point',V_T: '2d.Point'] :
      ( ( ( '2d.is-square/4' @ V_A @ V_B @ V_C @ V_D )
        ...
        & ( ( '-/2' @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_C @ V_H @ V_S ) ) @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_C @ V_S @ V_B ) ) )
          = ( '*/2' @ 90 @ 'Degree/0' ) )
        & ( ( '-/2' @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_T @ V_H @ V_C ) ) @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_D @ V_T @ V_C ) ) )
          = ( '*/2' @ 90 @ 'Degree/0' ) ) )
     => ? [V_K: '2d.Shape'] :
