...
thf(p,conjecture,(
    ! [V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point',V_P: '2d.Point'] :
     ...
     => ( ( $lesseq @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_P @ V_A @ V_B ) ) @ ( $quotient @ 'Pi/0' @ 6.0 ) )
        | ( $lesseq @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_P @ V_B @ V_C ) ) @ ( $quotient @ 'Pi/0' @ 6.0 ) )
        | ( $lesseq @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_P @ V_C @ V_A ) ) @ ( $quotient @ 'Pi/0' @ 6.0 ) ) ) ) )).
