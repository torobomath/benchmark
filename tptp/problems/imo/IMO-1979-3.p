...
thf(p,conjecture,(
    ! [V_C1: '2d.Shape',V_C2: '2d.Shape',V_A: '2d.Point',V_B: '2d.Point',V_theta1: 'R',V_theta2: 'R'] :
     ...
     => ? [V_P: '2d.Point'] :
        ! [V_theta: 'R'] :
          ( ( '2d.distance/2' @ V_P @ ( '2d.vec-translate/2' @ ( '2d.center-of/1' @ V_C1 ) @ ( '2d.sv*/2' @ ( '2d.radius-of/1' @ V_C1 ) @ ( '2d.vec2d/2' @ ( 'cos/1' @ ( '+/2' @ V_theta1 @ V_theta ) ) @ ( 'sin/1' @ ( '+/2' @ V_theta1 @ V_theta ) ) ) ) ) )
          = ( '2d.distance/2' @ V_P @ ( '2d.vec-translate/2' @ ( '2d.center-of/1' @ V_C2 ) @ ( '2d.sv*/2' @ ( '2d.radius-of/1' @ V_C2 ) @ ( '2d.vec2d/2' @ ( 'cos/1' @ ( '+/2' @ V_theta2 @ V_theta ) ) @ ( 'sin/1' @ ( '+/2' @ V_theta2 @ V_theta ) ) ) ) ) ) ) ) )).
