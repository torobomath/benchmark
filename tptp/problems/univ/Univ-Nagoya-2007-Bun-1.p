...
%            Number of atoms       :   63 (   0 equality;  29 variable)
%            Maximal formula depth :   21 (  21 average)
%            Number of connectives :   62 (   0   ~;   0   |;   6   &;  55   @)
%                                         (   0 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(p1,conjecture,(
    ! [V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point',V_Ap: '2d.Point',V_Bp: '2d.Point',V_Cp: '2d.Point',V_App: '2d.Point',V_Bpp: '2d.Point',V_Cpp: '2d.Point'] :
      ( ( ( '2d.divide-internally/4' @ V_Ap @ ( '2d.seg/2' @ V_A @ V_B ) @ 2 @ 1 )
        & ( '2d.divide-internally/4' @ V_Bp @ ( '2d.seg/2' @ V_B @ V_C ) @ 2 @ 1 )
        & ( '2d.divide-internally/4' @ V_Cp @ ( '2d.seg/2' @ V_C @ V_A ) @ 2 @ 1 )
        & ( '2d.divide-internally/4' @ V_App @ ( '2d.seg/2' @ V_Ap @ V_Bp ) @ 2 @ 1 )
        & ( '2d.divide-internally/4' @ V_Bpp @ ( '2d.seg/2' @ V_Bp @ V_Cp ) @ 2 @ 1 )
        & ( '2d.divide-internally/4' @ V_Cpp @ ( '2d.seg/2' @ V_Cp @ V_Ap ) @ 2 @ 1 ) )
     => ? [V_G: '2d.Point'] :
          ( ( '2d.lines-intersect-at/2' @ ( 'cons/2' @ ( '2d.line/2' @ V_A @ V_App ) @ ( 'cons/2' @ ( '2d.line/2' @ V_B @ V_Bpp ) @ ( 'cons/2' @ ( '2d.line/2' @ V_C @ V_Cpp ) @ 'nil/0' ) ) ) @ V_G )
