...
%            Number of atoms       :  121 (   4 equality;  67 variable)
%            Maximal formula depth :   27 (  18 average)
%            Number of connectives :  110 (   0   ~;   0   |;  21   &;  88   @)
%                                         (   0 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
thf(p2,conjecture,(
    ! [V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point',V_M: '2d.Point',V_l: '2d.Shape',V_P: '2d.Point',V_Q: '2d.Point',V_R: '2d.Point'] :
      ( ( ( '2d.is-isosceles-triangle/3' @ V_A @ V_B @ V_C )
        ...
        & ( '2d.on/2' @ V_R @ V_l )
        & ( '2d.on/2' @ V_R @ ( '2d.seg/2' @ V_A @ V_C ) ) )
     => ( $greater @ ( $product @ 2.0 @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_Q @ V_M @ V_R ) ) ) @ ( '2d.rad-of-angle/1' @ ( '2d.angle/3' @ V_Q @ V_M @ V_B ) ) ) ) )).
