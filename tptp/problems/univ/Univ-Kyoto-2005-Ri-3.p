...
%            Number of atoms       :   78 (  10 equality;  34 variable)
%            Maximal formula depth :   16 (  16 average)
%            Number of connectives :   62 (   6   ~;   0   |;  10   &;  46   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
    ...
    @ ^ [V_abc: '2d.Shape'] :
      ? [V_a: 'complex.Complex',V_b: 'complex.Complex',V_c: 'complex.Complex'] :
        ...
        & ( ( 'complex.+/2' @ V_a @ ( 'complex.+/2' @ V_b @ V_c ) )
          = ( 'complex.+/2' @ ( 'complex.^/2' @ V_a @ 2 ) @ ( 'complex.+/2' @ ( 'complex.^/2' @ V_b @ 2 ) @ ( 'complex.^/2' @ V_c @ 2 ) ) ) )
        & ( V_abc
...
thf(p_answer,answer,(
    ...
    ? [V_a_dot_0: 'complex.Complex',V_b_dot_0: 'complex.Complex',V_c_dot_0: 'complex.Complex'] :
      ...
      & ( ( 'complex.+/2' @ V_a_dot_0 @ ( 'complex.+/2' @ V_b_dot_0 @ V_c_dot_0 ) )
        = ( 'complex.+/2' @ ( 'complex.^/2' @ V_a_dot_0 @ 2 ) @ ( 'complex.+/2' @ ( 'complex.^/2' @ V_b_dot_0 @ 2 ) @ ( 'complex.^/2' @ V_c_dot_0 @ 2 ) ) ) )
      & ( V_abc_dot_0
      ...
      & ( '2d.is-center-of-gravity-of/2' @ ( '2d.point/2' @ 0 @ 0 ) @ V_abc_dot_0 ) ) ),
