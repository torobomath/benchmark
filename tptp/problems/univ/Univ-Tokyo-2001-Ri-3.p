...
%            Number of atoms       :   48 (   1 equality;  10 variable)
%            Maximal formula depth :   23 (  23 average)
%            Number of connectives :   45 (   0   ~;   0   |;   0   &;  44   @)
%                                         (   0 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
     ...
     => ( 'decreasing-at/2'
        @ ( 'fun/1'
          @ ^ [V_t_dot_0: 'R'] :
              ...
              @ ( 'LamApp/2'
                @ ^ [V_t_dot_2: 'R'] :
                    ( '2d.area-of/1' @ ( '2d.triangle/3' @ '2d.origin/0' @ ( '2d.point/2' @ 1 @ 1 ) @ ( '2d.point/2' @ V_t_dot_2 @ ( '//2' @ 1 @ V_t_dot_2 ) ) ) )
                @ V_t_dot_0 )
              @ ( 'LamApp/2'
                @ ^ [V_t_dot_1: 'R'] :
                    ( '2d.area-of/1'
                    @ ( '2d.shape-enclosed-by/1'
                      @ ( 'cons/2' @ ( '2d.seg/2' @ '2d.origin/0' @ ( '2d.point/2' @ 1 @ 1 ) )
                        @ ( 'cons/2' @ ( '2d.seg/2' @ '2d.origin/0' @ ( '2d.point/2' @ V_t_dot_1 @ ( '//2' @ 1 @ V_t_dot_1 ) ) )
                          @ ( 'cons/2'
                            @ ( '2d.shape-of-cpfun/1'
                              @ ^ [V_p: '2d.Point'] :
                                  ( 1
                                  = ( '*/2' @ ( '2d.x-coord/1' @ V_p ) @ ( '2d.y-coord/1' @ V_p ) ) ) )
                            @ 'nil/0' ) ) ) ) )
                @ V_t_dot_0 ) ) )
        @ V_t ) ) )).
