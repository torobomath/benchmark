...
%            Number of atoms       :  147 (  20 equality;  59 variable)
%            Maximal formula depth :   21 (  16 average)
%            Number of connectives :  110 (   3   ~;   1   |;  17   &;  89   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
%            Number of type conns  :    0 (   0   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   22 (   0   :)
%            Number of variables   :   27 (   2 sgn;   0   !;  13   ?;   6   ^)
%                                         (  19   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
...
thf(p2_qustion,question,
    ( 'Find/1'
    @ ^ [V_answer: 'ListOf' @ 'R'] :
      ? [V_O: '2d.Point',V_P: '2d.Point',V_Q: '2d.Point',V_l: '2d.Shape',V_x: 'R',V_y: 'R'] :
        ( ( V_O = '2d.origin/0' )
        & ( V_P
          = ( '2d.point/2' @ V_x @ V_y ) )
        & ( V_Q
...
thf(p1_answer,answer,(
    ...
    ? [V_x_dot_0: 'R',V_y_dot_0: 'R'] :
      ...
      & ( ( V_X != 0 )
        | ( V_Y != 0 ) )
      & ( V_x_dot_0
        = ( '//2' @ ( '*/2' @ 2 @ V_X ) @ ( '+/2' @ ( '^/2' @ V_X @ 2 ) @ ( '^/2' @ V_Y @ 2 ) ) ) )
      & ( V_y_dot_0
        = ( '//2' @ ( '*/2' @ 2 @ V_Y ) @ ( '+/2' @ ( '^/2' @ V_X @ 2 ) @ ( '^/2' @ V_Y @ 2 ) ) ) ) ) ),
