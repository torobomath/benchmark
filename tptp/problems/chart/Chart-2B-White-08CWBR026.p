...
thf(p,conjecture,(
    ! [V_L: '2d.Point',V_M: '2d.Point',V_N: '2d.Point',V_A: '2d.Point',V_B: '2d.Point',V_C: '2d.Point'] :
      ( ( ( V_L
          = ( '2d.internally-dividing-point/3' @ V_B @ V_C @ ( $quotient @ 3.0 @ 5.0 ) ) )
        & ( V_M
          = ( '2d.internally-dividing-point/3' @ V_C @ V_A @ ( $quotient @ 3.0 @ 5.0 ) ) )
        & ( V_N
          = ( '2d.internally-dividing-point/3' @ V_A @ V_B @ ( $quotient @ 3.0 @ 5.0 ) ) )
