...
%            Number of atoms       :  243 (  27 equality;  96 variable)
%            Maximal formula depth :   14 (  10 average)
%            Number of connectives :  192 (   3   ~;   0   |;  24   &; 165   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
%            Number of type conns  :    0 (   0   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   24 (   0   :)
%            Number of variables   :   57 (  12 sgn;   0   !;   9   ?;  12   ^)
%                                         (  21   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
...
thf(p11_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'R'] :
      ? [V_A: '3d.Point'] :
        ...
        & ( '3d.on/2' @ ( '3d.point/3' @ V_x @ V_y @ V_z ) @ ( '3d.plane2/2' @ V_A @ ( '3d.direction-vec/1' @ '3d.x-axis/0' ) ) ) ) )).
...
thf(p12_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'R'] :
      ? [V_A: '3d.Point'] :
        ...
        & ( V_answer
          = ( 'cons/2' @ V_x @ ( 'cons/2' @ V_y @ ( 'cons/2' @ V_z @ 'nil/0' ) ) ) )
        & ( '3d.on/2' @ ( '3d.point/3' @ V_x @ V_y @ V_z ) @ ( '3d.plane2/2' @ V_A @ ( '3d.direction-vec/1' @ '3d.y-axis/0' ) ) ) ) )).
...
thf(p13_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'R'] :
      ? [V_A: '3d.Point'] :
        ...
        & ( V_answer
          = ( 'cons/2' @ V_x @ ( 'cons/2' @ V_y @ ( 'cons/2' @ V_z @ 'nil/0' ) ) ) )
        & ( '3d.on/2' @ ( '3d.point/3' @ V_x @ V_y @ V_z ) @ ( '3d.plane2/2' @ V_A @ ( '3d.direction-vec/1' @ '3d.z-axis/0' ) ) ) ) )).
...
thf(p21_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'R'] :
      ? [V_B: '3d.Point',V_v: '3d.Vector'] :
        ...
        & ( '3d.on/2' @ ( '3d.point/3' @ V_x @ V_y @ V_z ) @ ( '3d.plane2/2' @ V_B @ V_v ) ) ) )).
