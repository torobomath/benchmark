...
%            Number of atoms       :  106 (  12 equality;  24 variable)
%            Maximal formula depth :   17 (  12 average)
%            Number of connectives :   82 (   0   ~;   6   |;   6   &;  70   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(p1_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'Z'] :
      ? [V_x: 'Z',V_y: 'Z'] :
        ...
        & ( 12
          = ( 'int.+/2' @ ( 'int.^/2' @ V_x @ 2 ) @ ( 'int.*/2' @ -4 @ ( 'int.^/2' @ V_y @ 2 ) ) ) ) ) )).
...
thf(p2_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'Z'] :
      ? [V_x: 'Z',V_y: 'Z'] :
        ...
        & ( 'int.is-integer/1' @ V_y )
        & ( 0
          = ( 'int.+/2' @ ( 'int.+/2' @ ( 'int.+/2' @ ( 'int.*/2' @ V_x @ V_y ) @ ( 'int.*/2' @ -3 @ V_x ) ) @ ( 'int.*/2' @ -2 @ V_y ) ) @ 3 ) ) ) )).

thf(p1_answer,answer,(
    ^ [V_answer_dot_0: 'ListOf' @ 'Z'] :
      ( ( V_answer_dot_0
        = ( 'cons/2' @ 4 @ ( 'cons/2' @ -1 @ 'nil/0' ) ) )
      | ( V_answer_dot_0
        = ( 'cons/2' @ 4 @ ( 'cons/2' @ 1 @ 'nil/0' ) ) )
      | ( V_answer_dot_0
        = ( 'cons/2' @ -4 @ ( 'cons/2' @ 1 @ 'nil/0' ) ) )
