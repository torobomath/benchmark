...
thf(p1_qustion,question,
    ...
    @ ^ [V_answer: 'ListOf' @ 'Z'] :
      ? [V_x: 'Z',V_y: 'Z',V_z: 'Z'] :
        ...
        & ( 'int.</2' @ 0 @ V_y )
        & ( ( 'rat.ratio/2' @ 4 @ 3 )
          = ( 'rat.+/2' @ ( 'rat.+/2' @ ( 'rat.ratio/2' @ 1 @ ( 'int.*/2' @ 3 @ V_x ) ) @ ( 'rat.ratio/2' @ 1 @ ( 'int.*/2' @ 2 @ V_y ) ) ) @ ( 'rat.ratio/2' @ 1 @ V_z ) ) ) ) )).
...
thf(p1_answer,answer,(
    ^ [V_answer_dot_0: 'ListOf' @ 'Z'] :
      ( ( V_answer_dot_0
        = ( 'cons/2' @ 2 @ ( 'cons/2' @ 3 @ 'nil/0' ) ) )
      | ( V_answer_dot_0
        = ( 'cons/2' @ 4 @ ( 'cons/2' @ 2 @ 'nil/0' ) ) ) ) ),
...
thf(p3_answer,answer,(
    ^ [V_answer_dot_0: 'ListOf' @ 'Z'] :
      ...
      | ( V_answer_dot_0
        = ( 'cons/2' @ 4 @ ( 'cons/2' @ 2 @ ( 'cons/2' @ 1 @ 'nil/0' ) ) ) )
      | ( V_answer_dot_0
        = ( 'cons/2' @ 1 @ ( 'cons/2' @ 1 @ ( 'cons/2' @ 2 @ 'nil/0' ) ) ) ) ) ),
